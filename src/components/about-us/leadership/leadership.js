  ...
  `)
    ...
    return (
      <div className="leadership-content">
        <h5 className="leadership-content-pre-title container">the team</h5>
        <h2 className="leadership-content-title container">Our leadership</h2>
        <div className="leadership-content-top container">
          <img className="leadership-content-top-arrow arrow-left" src={data.arrowPrev.publicURL}/>

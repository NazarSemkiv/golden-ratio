    ...
    return (
      <div id="why-we-made-content">
        ...
        <div className="why-we-made-top container">
          <h5 className="why-we-made-pre-title">the reason</h5>
          <h2 className="why-we-made-title">
            <p>Why we made</p>
            <p>Golden Ratio System?</p>
          </h2>
          <p className="why-we-made-text"> Golden info created lorem ipsum dolor sit amet, consectetur adipiscing elit. 
          ...
          <h3 className="why-we-made-quotes">"What if we could do something different?"</h3>
          <p className="why-we-made-text">And so, they built Golden Ratio Systems.</p>
        </div>
